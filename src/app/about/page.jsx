...
export default function About() {
  return (
    <>
      ...
      {/* Main Container - Two Column Responsive Grid */}
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="flex items-center space-x-3 text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 transition-colors"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
