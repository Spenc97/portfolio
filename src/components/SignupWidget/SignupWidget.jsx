...
const SignupWidget = ({ title, content, simulateNetworkRequestTime }) => {
  ...
  //const [emailError, setEmailError] = useState(''); //added this code
        ...
        <>
          ...
          <div className={"input-row"}>
            ...
            */}
            ...
            />
            {!email && (
              <span className="error-message" data-testid="signupWidgetError">
                {!email}
              </span>
            )}
            ...
            */}
            <button data-testid="signupWidgetButton" type="submit" disabled={busy} style={{ marginLeft: "8px" }}>
              {busy ? "Joining..." : "Join"}
            </button>
          </div>
        </>
